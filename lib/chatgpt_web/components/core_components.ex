  ...
  def flash(assigns) do
    ...
    <div
      ...
      class={[
        ...
        @kind == :info && "bg-indigo-50 text-indigo-800 ring-indigo-500 fill-cyan-900",
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "mt-2 block min-h-[6rem] w-full rounded-lg border-gray-400 py-[7px] px-[11px]",
          "text-gray-600 focus:border-gray-600 focus:outline-none focus:ring-4 focus:ring-zinc-800/5 sm:text-sm lg:text-md sm:leading-6",
          "phx-no-feedback:border-zinc-300 phx-no-feedback:focus:border-zinc-400 phx-no-feedback:focus:ring-zinc-800/5",
          "border-zinc-300 focus:border-zinc-400 focus:ring-zinc-800/5 tracking-tight",
